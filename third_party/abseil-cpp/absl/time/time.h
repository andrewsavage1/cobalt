...
ABSL_ATTRIBUTE_CONST_FUNCTION CONST_MODIFIER int64_t ToInt64Microseconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION CONST_MODIFIER int64_t ToInt64Milliseconds(Duration d);
